...
<?php
  ...
  if(isset($_GET['add_id']))
  {
      ...
      $result2 = mysqli_query($connect,$query2);
  		...
  		if($result1 && $result2)
  		{
  			header("Location: advertisement_pending.php?msg=advertisement_deleted&&user_id=$user_id");
  		}
  		else
  		{
  			header("Location: advertisement_pending.php?error=advertisement_delete_failed&&user_id=$user_id");
  		}
