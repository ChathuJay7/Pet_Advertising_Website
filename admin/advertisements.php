...
<?php
 ...
 $search = '';
  ...
  {
  	$query = "SELECT * FROM advertisement ORDER BY AddId DESC";
  }
 	...
 	<div id="content" class="content">
 		<div class="home-content">
		 	...
		 	<div class = "search">
				...
				<form action="advertisements.php?user_id=<?php echo $user_id ?>" method="get">
        ...
        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
				...
				<a  href="advertisements.php?user_id=<?php echo $user_id ?>"><button>REFRESH</button></a>
