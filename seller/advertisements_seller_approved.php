...
<?php
  ...
  {
   $query = "SELECT * FROM advertisement WHERE IsDeleted = 0 AND IsApproved='true' AND SellerId={$seller_id} ORDER BY AddId DESC";
  }
...
<head>
  <meta charset="UTF-8">
  <title>My Approved Advertiesments</title>
...
<div id="content" class="content">
   ...
   <div class="home-content">
         ...
         <div class = "search">
            ...
            <form action="advertisements_seller_approved.php?seller_id=<?php echo $seller_id; ?>" method="get">
            ...
            <a  href="advertisements_seller_approved.php?seller_id=<?php echo $seller_id; ?>"><button>REFRESH</button></a>
